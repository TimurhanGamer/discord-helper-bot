...
const youtube = new YouTube('AIzaSyA0Fu8FlKe7FRoo0tGgcEpf3HcxqR-EMQA');
const queue = new Map();
...
const dmembed = new Discord.RichEmbed()
  .setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor!")
    .setColor(0x00AE86)
    .setDescription(" " + msg.author.tag + " Sunucunda Reklam Yapıyor d!uyar komutu ile kişiyi uyara bilir d!ban Komutu İle Kişiyi Banlayabilirsin ")
  .addField("Kullanıcının mesajı:", "**" + msg.content + "**")
